...
* [Latest Stable Release](https://github.com/pkgforge-dev/vcmi-AppImage/releases/latest)
...
* [AM](https://github.com/ivan-hc/AM) `am -i vcmi` or `appman -i vcmi`

* [dbin](https://github.com/xplshn/dbin) `dbin install vcmi.appimage`

* [soar](https://github.com/pkgforge/soar) `soar install vcmi`
